...
public class Decryptor {
    ...
    public Decryptor(int port) {
        ...
        logger.info("Server established - {}", Decryptor.class.getSimpleName());
        try {
        ...
        while (true) {
            ...
            try {
                new Replier().send(channel, new Container(executor.executeCommand((Command) command.getObject()), command.getAddress()));
